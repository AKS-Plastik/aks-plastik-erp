...
function OrderDetailModal({ order, onClose, onAdvance, canAct, canChangeTo }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      <div className="bg-surface-container-lowest rounded-2xl shadow-xl w-full max-w-4xl p-5 md:p-8 max-h-[90vh] overflow-y-auto mx-4" onClick={(e) => e.stopPropagation()}>
